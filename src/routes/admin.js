...
router.post("/product/checkAdmin", adminController.checkAdmin);
router.post("/product/checkNameNew", adminController.checkName);
router.post("/product/checkName/:product_id", adminController.checkName);
